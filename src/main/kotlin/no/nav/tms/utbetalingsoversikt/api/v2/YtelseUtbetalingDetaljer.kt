...
class YtelseUtbetalingDetaljer(
    ...
    @Serializable(with=BigDecimalSerializer::class) val bruttoUtbetalt = underytelse.sumOf { it.beløp }
    @Serializable(with=BigDecimalSerializer::class) val nettoUtbetalt = underytelse.sumOf { it.beløp } - trekk.sumOf { it.beløp }
