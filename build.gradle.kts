...
dependencies {
    ...
    implementation("com.github.navikt.tms-ktor-token-support:token-support-tokendings-exchange:cookie-samesite-domain-path-SNAPSHOT")
    implementation("com.github.navikt.tms-ktor-token-support:token-support-idporten:cookie-samesite-domain-path-SNAPSHOT")
